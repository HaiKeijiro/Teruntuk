...
export const pairingFields = [
  ...
  },
  {
    ...
    gridCols: "col-span-12 md:col-span-12",
  },
];
...
export const eventFields = [
  ...
  },
  {
    ...
    name: "mulaiPada",
    type: "datetime-local",
    gridCols: "col-span-12 md:col-span-4",
  },
  {
    label: "Selesai pada",
    name: "selesaiPada",
  ...
  { label: "Kota", name: "kota", type: "text", gridCols: "col-span-12 md:col-span-6" },
  { label: "Alamat", name: "alamat", textarea: true, gridCols: "col-span-12 md:col-span-12" },
];
...
export const additionalFields = [
  ...
  { label: "Musik", name: "musik", type: "file", gridCols: "col-span-12 md:col-span-6" },
  {
    label: "Gambar cover",
    name: "gambarCover",
    type: "file",
  ...
  { label: "Galeri", name: "galleri", type: "file", gridCols: "col-span-12 md:col-span-6" },
];
